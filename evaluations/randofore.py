...
def generate_roc_auc(validation_labels):
    ...
    classifier_numeric = OneVsRestClassifier(RandomForestClassifier(n_estimators=100, random_state=42))
...
classifier_rf.fit(X_train, ground_truth)

predictions = classifier_rf.predict(X_validation)
...
# Generating Log Loss
probabilities = classifier_rf.predict_proba(X_validation)
