...
def generate_roc_auc(validation_labels):
    ...
    classifier_numeric = OneVsRestClassifier(DecisionTreeClassifier())
...
classifier_detree = DecisionTreeClassifier()
classifier_detree.fit(X_train, ground_truth)

predictions = classifier_detree.predict(X_validation)
...
# Generating Log Loss
probabilities = classifier_detree.predict_proba(X_validation)
