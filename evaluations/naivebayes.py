...
def generate_roc_auc(validation_labels):
    ...
    classifier_numeric = OneVsRestClassifier(MultinomialNB())
...
classifier_nb.fit(X_train, ground_truth)

predictions = classifier_nb.predict(X_validation)
...
# Generating Log Loss
probabilities = classifier_nb.predict_proba(X_validation)
